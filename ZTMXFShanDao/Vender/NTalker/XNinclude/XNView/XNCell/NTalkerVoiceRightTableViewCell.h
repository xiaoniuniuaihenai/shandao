...
@class XNVoiceMessage;

@protocol XNResendVoiceMsgDelegate <NSObject>
...
@class XNBaseMessage;
@interface NTalkerVoiceRightTableViewCell : UITableViewCell
...
@property (nonatomic, weak) id<XNResendVoiceMsgDelegate> delegate;
