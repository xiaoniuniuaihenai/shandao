...
static const CGFloat SVProgressHUDHorizontalSpacing = 8.0f;
...
- (void)updateHUDFrame {
    ...
    hudWidth = SVProgressHUDHorizontalSpacing + labelWidth + contentWidth + SVProgressHUDHorizontalSpacing;
    ...
    CGFloat centerY = CGRectGetMidY(self.hudView.bounds);
    CGFloat indefiniteAnimatedViewCenterX = SVProgressHUDHorizontalSpacing + CGRectGetWidth(self.indefiniteAnimatedView.frame) / 2.0;
    if (!self.statusLabel.text) {
        indefiniteAnimatedViewCenterX = CGRectGetMidX(self.hudView.bounds);
    }
    self.indefiniteAnimatedView.center = CGPointMake(indefiniteAnimatedViewCenterX, centerY);
    if(self.progress != SVProgressHUDUndefinedProgress) {
        self.backgroundRingView.center = self.ringView.center = CGPointMake(indefiniteAnimatedViewCenterX, centerY);
    }
    self.imageView.center = CGPointMake(indefiniteAnimatedViewCenterX, centerY);
    ...
    self.statusLabel.center = CGPointMake(CGRectGetMaxX(self.indefiniteAnimatedView.frame) + CGRectGetWidth(self.statusLabel.frame) / 2.0, CGRectGetMidY(self.indefiniteAnimatedView.frame));
