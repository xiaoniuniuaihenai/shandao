...
#pragma mark -- 下载完之后添加动画
-(void)sd_setImageFadeEffectWithURLstr:(NSString*)imgUrl placeholderImage:(NSString *)imgName  {
    NSURL * url = [NSURL URLWithString:imgUrl];
    [self sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:imgName] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
