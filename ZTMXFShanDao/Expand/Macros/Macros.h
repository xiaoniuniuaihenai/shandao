...
#define CHINESE_BOLD_SYSTEM(x) [UIFont boldSystemFontOfSize:x]
...
#define AdaptedBoldFontSize(R)     CHINESE_BOLD_SYSTEM(AdaptedWidth(R))
...
#define PayTypeViewHeight (SCREEN_HEIGHT > 580 ? 453.0 / 667.0 * SCREEN_HEIGHT : 450.0)

//状态栏高度
#define Status_Bar_Height  [[UIApplication sharedApplication] statusBarFrame].size.height
// 导航栏高度
#define k_Navigation_Bar_Height   (Status_Bar_Height + 44.0)
// 底部TabBar高度
#define TabBar_Height          (Status_Bar_Height > 21.0 ? 83.0 : 49.0)
//  Iphone X 底部TabBar增加的高度
#define TabBar_Addition_Height (Status_Bar_Height > 21.0 ? 34.0 : 0.0)
...
//字体色彩字符串
/** 标题.正文部分重要文字颜色 */
#define COLOR_BLACK_STR     @"333333"
/** 模块标题颜色/说明文字 */
#define COLOR_GRAY_STR      @"666666"
#define COLOR_GRAY_STR1      @"7d7d7d"
#define COLOR_LIGHT_STR     @"999999"
#define COLOR_LIGHT_STR1     @"b8b8b8"
#define COLOR_LIGHT_STR2     @"d1d1d1"
#define COLOR_BORDER_STR    @"#F2F2F2"
#define COLOR_DEEPBORDER_STR @"d3d3d3"
#define COLOR_WHITE_STR     @"ffffff"
#define COLOR_BLUE_STR      @"4990e2"
#define COLOR_ORANGE_STR    @"FE963B"
#define COLOR_LIGHT_GRAY_STR @"888888"
//  主题色
#define COLOR_RED_STR       @"F85C3B"

//背景颜色
#define COLOR_LIGHTBG_STR    @"f2f4f5"

//  按钮不可点击背景颜色
#define COLOR_UNUSABLE_BUTTON @"CDCDCD"
