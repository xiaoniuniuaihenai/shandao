...
- (void)uploadLoanListDataWithIndex:(NSInteger)index{
    ...
    _mainTableView.mj_footer.state = MJRefreshStateIdle;
    [_mainTableView reloadData];
    self.mainTableView.height = SCREEN_HEIGHT-Navigation_Bar_Height-(self.billType == LSLoanNotReturnType ? AdaptedHeight(60) : 0);
}
...
- (UITableView *)mainTableView{
    if (!_mainTableView) {
        _mainTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, Navigation_Bar_Height, SCREEN_WIDTH, SCREEN_HEIGHT-Navigation_Bar_Height-AdaptedHeight(60)) style:UITableViewStylePlain];
