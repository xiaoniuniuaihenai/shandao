...
//        _themeColor = [UIColor redColor];
        //上部水纹图
        MoxieWaterRippleView *rippleView = [[MoxieWaterRippleView alloc]initWithFrame:CGRectMake((kScreenWidth-125.f/667.f*kScreenHeight)/2, 150.f/667.f*kScreenHeight, 125.f/667.f*kScreenHeight, 125.f/667.f*kScreenHeight)];
        ...
        if(_loadingViewText){
            UILabel * textLabel = [[UILabel alloc]initWithFrame:CGRectMake(30, kScreenHeight - 190.f/667.f*kScreenHeight+30.f/667.f*kScreenHeight, kScreenWidth-60, 120.f/667.f*kScreenHeight)];
            ...
            for (int i = 0; i<MAX_MESSAGE; i++) {
                UIView *staView = [[UIView alloc]initWithFrame:CGRectMake(0, kScreenHeight - 190.f/667.f*kScreenHeight+30.f*i/667.f*kScreenHeight, kScreenWidth, 24.f/667.f*kScreenHeight)];
        ...
        //账号显示
        self.accountLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 372.f/667.f*kScreenHeight, kScreenWidth, 20)];
        ...
        _timeLabel = [[UILabel alloc]initWithFrame:CGRectMake((kScreenWidth - 105)/2, 397.f/667.f*kScreenHeight, 105, 18)];
        ...
        _currentLinePointY = [UIScreen mainScreen].bounds.size.height-215.f/667.f*kScreenHeight;
        [self animateWave];
    }
    return self;
}
...
#pragma MoxieSDKProgressDelegate  进度回调代理
